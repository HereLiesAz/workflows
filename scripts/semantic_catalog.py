...
SEMANTIC_WORKFLOWS: Final[dict[str, dict[str, object]]] = {
    ...
    ".github/workflows/multi-platform-app-release.yml": {
        ...
        "source_hashes": {
            ...
            # (Windows, macOS, Linux) and webOS/Tizen TV packages from web/ and desktop/.
            "a5a99b3c11e57edefa84f4be6d44dcbc8a3b4357b64c2f1a465d22909fc68068",
    ...
    ".github/workflows/cloudflare-worker-deploy.yml": {
        ...
        "source_hashes": {
            ...
            # HereLiesAz/illumera:.github/workflows/web-deploy.yml — tests, builds and
            # deploys web/ on pushes touching it (purpose profile below).
            "a90a3f56cdc247d4df2f4a53a7f68a18123e71759f2b88d0e5fa0bb97df18034",
        },
    },
}
...
PURPOSE_PROFILES: Final[dict[str, dict[str, object]]] = {
    ...
    "60ac0b25cf88bcff28f3b5c31d1d9545e5a6ba10d9b80d1b7d35e540329b350e": {"signing":"raw-jks","signing_env_style":"release-store","java_version":"21","setup_android":True,"android_packages":"platform-tools","google_services":"none","package_name":"com.hereliesaz.illumera","pre_build_command":"test \"$VERSION_MAJOR\" -le 1 && test \"$VERSION_MINOR\" -le 99 && test \"$VERSION_PATCH\" -le 999 && test \"$VERSION_BUILD\" -le 9999 || { echo \"::error::$VERSION cannot be encoded as an illumera versionCode\" >&2; exit 1; }; code=$(( VERSION_MAJOR * 1000000000 + VERSION_MINOR * 10000000 + VERSION_PATCH * 10000 + VERSION_BUILD )); echo \"RELEASE_VERSION_CODE=$code\" >> \"$GITHUB_ENV\"","build_command":"./gradlew :app:testDebugUnitTest :app:lintRelease :app:assembleRelease :app:bundlePlay --no-daemon --stacktrace","aab_glob":"app/build/outputs/bundle/play/*.aab","apk_glob":"app/build/outputs/apk/release/*.apk","publish_on_push":True,"publish_default":True,"persist_version":False,"tracks":[{"track":"internal","status":"completed"},{"track":"alpha","status":"draft","preserve_existing":True,"name":"illumera $VERSION"}],"github_built_release_always":True,"github_built_release_tag_env":"VERSION","github_built_release_include_aab":False,"github_built_release_checksum":True,"github_built_release_changes":True,"release_app_name":"illumera"},
