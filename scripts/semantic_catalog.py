...
SEMANTIC_WORKFLOWS: Final[dict[str, dict[str, object]]] = {
    ...
    ".github/workflows/multi-platform-app-release.yml": {
        ...
        "source_hashes": {
            ...
            # (Windows, macOS, Linux), webOS/Tizen TV packages and the Roku channel.
            "7d870343f471c1c3f1a3d2e0a6712af45c74b500a3b0b32f6069ac3493eb09c0",
    ...
    ".github/workflows/cloudflare-worker-deploy.yml": {
        ...
        "source_hashes": {
            ...
            # HereLiesAz/CueDetat:.github/workflows/capture-relay-deploy.yml — tests and
            # deploys the training-capture relay in ml/capture-relay (purpose profile below).
            "cc3b3d2f63a2ff31d475af991e561c7ff8003b432b51c8b1c41a084ad82c0171",
        },
    },
}
...
PURPOSE_PROFILES: Final[dict[str, dict[str, object]]] = {
    ...
    "a90a3f56cdc247d4df2f4a53a7f68a18123e71759f2b88d0e5fa0bb97df18034": {"working_directory": "web", "test_command": "npm test && npm run build", "worker_secrets": ["TRAKT_CLIENT_ID", "TRAKT_CLIENT_SECRET"]},
    # CueDetat's training-capture relay: a Worker in ml/capture-relay with its own npm test.
    "cc3b3d2f63a2ff31d475af991e561c7ff8003b432b51c8b1c41a084ad82c0171": {"working_directory": "ml/capture-relay", "test_command": "npm test"},
