...
SEMANTIC_WORKFLOWS: Final[dict[str, dict[str, object]]] = {
    ...
    ".github/workflows/cloudflare-worker-deploy.yml": {
        ...
        "source_hashes": {
            ...
            "50d817ee50a446433ffbef25a965568c6864d4cb4508c0227c3dee2ceecbc230",
        },
    },
}
...
PURPOSE_PROFILES: Final[dict[str, dict[str, object]]] = {
    ...
    "50d817ee50a446433ffbef25a965568c6864d4cb4508c0227c3dee2ceecbc230": {"working_directory": "web", "test_command": "npm test && npm run build"},
